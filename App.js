...
import ReduxRcts from './components/reduxReactComp';
import Profile from './components/profileComp';
import { Provider } from 'react-redux';
import createTodoStore from './components/todoStore';
              ...
              <div className='appMain'>
                  ...
                  <ContentComp>
                      ...
                      <Provider store={store}>
                          <Route path="/rdxRcts" name="rdxRcts" component={ReduxRcts}></Route>
                      </Provider>
